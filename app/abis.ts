export const MACRO_FORWARDER_ABI = [
    "function runMacro(address macro, bytes calldata params)"
  ]
  
export const REWARDS_MACRO_ABI = [
    "function getParams(address pool, address[] memory receivers, uint128[] memory units, int96 flowRate) external pure returns (bytes memory)"
  ]
...
export const SUPER_TOKEN_ABI = ["function balanceOf(address account) external view returns (uint256)"]